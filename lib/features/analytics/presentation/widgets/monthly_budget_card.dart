...
class _MonthlyBudgetCardState extends State<MonthlyBudgetCard> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant MonthlyBudgetCard oldWidget) {
