...
extension SyncQueueItemQuerySortBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> sortBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQuerySortThenBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> thenBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.asc);
    });
  }
...
extension SyncQueueItemQueryWhereDistinct
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QDistinct> distinctBySyncStatus(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQueryProperty
  ...
  QueryBuilder<SyncQueueItem, String, QQueryOperations> syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
